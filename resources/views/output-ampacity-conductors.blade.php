    ...
    <script>
        ...
        switch (true) {
            case numericPercentage >= 81:
                ...
                output.innerHTML =
                    "It indicates that the system is at risk condition and in violation according to PEC 2.10.2.2 (A).";
                break;
            case numericPercentage >= 75 && numericPercentage <= 80:
                ...
                output.innerHTML =
                    "It indicates that the system is almost near the 80% threshold and still acceptable according to PEC 2.10.2.2 (A).";
                break;
            case numericPercentage >= 0 && numericPercentage <= 74:
                ...
                output.innerHTML =
                    "It indicates that the system is at safe condition and acceptable according to PEC 2.10.2.2 (A).";
                break;
            default:
