...
@section('content')
    <section>
        ...
        <div class="p-10 flex overflow-x-auto hide-scrollbar space-x-6 w-screen">
            ...
            <div class="w-full sm:w-full md:w-1/4 lg:w-1/5 ">
                {{-- LINK 2 --}}
                <a href="/ampacity-of-conductors/guest">
                    <div
                        class="flex flex-col justify-between bg-white rounded-lg overflow-hidden shadow-md h-[250px] w-[150px] sm:w-full sm:h-full transition duration-500 hover:scale-110 min-w-[200px]">
            ...
            <div class="w-full sm:w-full md:w-1/4 lg:w-1/5">
                {{-- LINK 3 --}}
                <a href="/percentage-of-voltage/guest">
                    <div
                        class="flex flex-col justify-between bg-white rounded-lg overflow-hidden shadow-md h-[250px] w-[150px] sm:w-full sm:h-full transition duration-500 hover:scale-110 min-w-[200px]">
            ...
            <div class="w-full sm:w-full md:w-1/4 lg:w-1/5">
                {{-- LINK 5 --}}
                <a href="/energy-conservation/guest">
                    <div
                        class="flex flex-col justify-between bg-white rounded-lg overflow-hidden shadow-md h-[250px] w-[150px] sm:w-full sm:h-full transition duration-500 hover:scale-110 min-w-[200px]">
